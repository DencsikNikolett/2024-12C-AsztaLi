...
{
    public class SHTipus
    {
        protected int a, b, c;

        // Konstruktor, hibakezeléssel
        public SHTipus(int a, int b, int c)
        {
...
/*Konstruktor hibakezelés: Ha bármelyik oldal nulla vagy negatív, dobunk egy ArgumentException-t.
ArgumentException azt jelzi, hogy a metódusba bemeneti adat (argumentum) lett megadva, de az nem felelt meg a várt feltételeknek. 
Ebben az esetben a háromszög oldalainak pozitív számoknak kell lenniük.

Terület számítása hibakezelés: Ha nem háromszög, dobunk egy InvalidOperationException-t.
InvalidOperationException akkor dobódik, amikor a metódus végrehajtása nem érvényes a 
program jelenlegi állapota alapján.

Kiírás hibakezelés: A Kiir() metódusban is meg kell győződni arról, hogy minden szükséges ellenőrzés megtörtént.*/
